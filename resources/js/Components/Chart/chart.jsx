...
const Chart = () => {
    const { data: response, error } = useGet("https://www.nosyapi.com/apiv2/service/economy/historical-data/currency-conversion?apiKey=LFSxbMAeJFUfFCNPVFmEBebhMFmQE7Ldwu2lfCSwyvAuEboUVCKw3bzuDhCF&date=2023-07-30&code=TRY");
